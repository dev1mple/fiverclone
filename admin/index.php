        ...
        <div class="row mb-5">
            ...
            <div class="col-md-3 mb-4">
                <div class="card quick-action-card h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <i class="fas fa-briefcase text-info" style="font-size: 3rem;"></i>
                        </div>
                        <h5 class="card-title">Proposals</h5>
                        <p class="card-text">Monitor and manage all platform proposals</p>
                        <a href="proposals.php" class="btn btn-info">
            ...
            <div class="col-md-3 mb-4">
                <div class="card quick-action-card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Monitor all offers and client submissions</p>
                        <a href="offers.php" class="btn btn-warning">
                            <i class="fas fa-list me-2"></i>View All
                        </a>
                    </div>
                </div>
