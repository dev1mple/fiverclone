            ...
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    ...
                    <a href="index.php" class="btn btn-outline-light btn-lg">
                        <i class="fas fa-home me-2"></i>View as Client
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card feature-card text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Submit Offers</h5>
                        <p class="card-text">
                            As an administrator, you can also act as a client and submit offers 
                            to freelancer proposals.
                        </p>
                        <a href="index.php" class="btn btn-success">
                            <i class="fas fa-plus me-2"></i>Submit Offers
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="alert alert-info text-center">
                    ...
                    <p class="mb-0">
                        ...
                        to monitor activity. Remember, you can switch between admin and client roles seamlessly!
                    </p>
                </div>
            </div>
        </div>
